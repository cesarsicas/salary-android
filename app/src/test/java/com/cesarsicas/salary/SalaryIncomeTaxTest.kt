...
class SalaryIncomeTaxTest {
    ...
    fun salaryIncomeTaxFirstSlice() {
        ...
        assertEquals(0.0, salaryCalculator.calculateIncomeDiscount(1000.0), 0.0001)
    ...
    fun salaryIncomeTaxSecondSlice() {
        ...
        assertEquals(142.80, salaryCalculator.calculateIncomeDiscount(2000.0), 0.0001)
    ...
    fun salaryIncomeTaxThirdSlice() {
        ...
        assertEquals(354.80 , salaryCalculator.calculateIncomeDiscount(3000.0), 0.0001)
    ...
    fun salaryIncomeForthSlice() {
        ...
        assertEquals(636.13, salaryCalculator.calculateIncomeDiscount(4000.0), 0.0001)
    ...
    fun salaryIncomeTaxFifthSlice() {
        ...
        assertEquals(869.36, salaryCalculator.calculateIncomeDiscount(5000.0), 0.0001)
